...
RUN_DIR=${RUN_DIR:-qwen38-fsod-runs/defect-detection-sparse-prompt-ab-v1}
CONDITIONS=${CONDITIONS:-qwen38-fsod-configs/defect-detection-sparse-prompt-ab.json}
...
if [[ "$PREPARE_ONLY" == "1" ]]; then
  echo "Defect Detection sparse-reference A/B preflight completed; inference intentionally skipped."
  exit 0
fi
...
echo "Defect Detection sparse-reference A/B completed successfully."
